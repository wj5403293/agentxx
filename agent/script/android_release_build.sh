...
BOOST_ROOT=$(cd "$src_dir/third_party/boost-android-build-release/arm64-v8a" && pwd)
OPENSSL_ROOT_DIR=$(cd "$src_dir/third_party/OpenSSL-android/arm64-v8a" && pwd)
...
echo "============================================"
echo "  编译完成!"
echo "  输出目录: $build_dir/agentxx-project-install/"
echo "============================================"