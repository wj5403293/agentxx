...
asio::awaitable<void> test_html_to_markdown_basic(
...
asio::awaitable<void> test_html_to_markdown_empty_content(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringHtml2MarkdownTool{agentContext};
...
asio::awaitable<void> test_html_to_markdown_convert(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringHtml2MarkdownTool{agentContext};
...
asio::awaitable<void> test_html_to_markdown_simple_text(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringHtml2MarkdownTool{agentContext};
...
asio::awaitable<void> test_regexp_get_definition(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
...
asio::awaitable<void> test_regexp_empty_content(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
...
asio::awaitable<void> test_regexp_empty_exps(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
      {"content", "some text"},
...
asio::awaitable<void> test_regexp_empty_opt(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
      {"content", "some text"},
...
asio::awaitable<void> test_regexp_invalid_opt(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
      {"content", "some text"},
...
asio::awaitable<void> test_regexp_search_match(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
...
asio::awaitable<void> test_regexp_search_no_match(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
      {"content", "hello world"},
...
asio::awaitable<void> test_regexp_replace_no_match(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
      {"content", "hello world"},
...
asio::awaitable<void> test_regexp_remove_no_match(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
      {"content", "hello world"},
...
asio::awaitable<void> test_regexp_search_multi_patterns(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
...
asio::awaitable<void> test_regexp_replace_multi_patterns(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::StringRegexpTool{agentContext};
  auto args = neograph::json{
