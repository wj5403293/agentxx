...
asio::awaitable<void> test_web_search_get_definition(
...
asio::awaitable<void> test_web_search_empty_query(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::WebSearchTool{"https://example.com/search?q={}",
                                            false, agentContext};
...
asio::awaitable<void> test_web_fetch_url_get_definition(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
...
asio::awaitable<void> test_web_fetch_url_empty_url(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::WebFetchUrlTool{agentContext};
...
asio::awaitable<void> test_web_fetch_url_default_timeout(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::WebFetchUrlTool{agentContext};
  auto def = tool.get_definition();
  auto &params = def.parameters;
