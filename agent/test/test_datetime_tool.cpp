...
asio::awaitable<void> test_datetime_get_definition(
...
asio::awaitable<void> test_datetime_execute(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::GetCurrentDateTimeTool{agentContext};
...
asio::awaitable<void> test_datetime_timestamp_format(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::GetCurrentDateTimeTool{agentContext};
  auto result = co_await tool.execute_async(neograph::json{});
...
asio::awaitable<void> test_datetime_date_format(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::GetCurrentDateTimeTool{agentContext};
  auto result = co_await tool.execute_async(neograph::json{});
...
asio::awaitable<void> test_datetime_time_format(
    std::weak_ptr<agentxx::agent::AgentContext> agentContext) {
  auto tool = agentxx::tools::GetCurrentDateTimeTool{agentContext};
  auto result = co_await tool.execute_async(neograph::json{});
